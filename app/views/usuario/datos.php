<div class="container clearfix">
	...
	<div class="panel col-md-3 col-sm-4 col-xs-12">
	 	<div style="text-align:center;">
	 		<img src="public/imagenes/usuario.png">
	 	</div></br></br>
        ...
        <div class="apanel"><a href="misd">Editar mi información</a></div>
	 	...
	 	<div class="apanel"><a href="public/mispedidos">Mis Pedidos</a></div>
	...
	<div class="panel2 col-md-8 col-sm-7 col-xs-12  col-md-offset-1 col-sm-offset-1">
        ...
        <p> <a href="public/contrasena/nuevo" class="cambiarcontra"> Cambiar la contraseña </a></p>
        </div>
