...
<body>
    ...
    <div class="headerp">
        ...
        <div class="sesion">
          <div class="sesionp"> Hola <span class="minombre" ><?php echo $usuario->nombres; ?>  <a href="public/cerrar"><img src="public/imagenes/cerrar.png" class="imgcerrar"></a></span></div> 
          <div class="sesionp">|</div>
          <div class="sesionp"><a href="public/micuenta"> Mi Cuenta</a> </div> 
          <div class="sesionp">|</div>
