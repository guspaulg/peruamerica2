 ...
 <div class="container clearfix">
    ...
    <div id="description">
      <div class="sixteen columns">
        ...
        <h1 class="big2">404</h1>
        <p class="bottom-2">
         ¿Quieres conocer de nuestros servicios? </br>Somos la Primera Imprenta Online de Perú.
        </p>
        <a href="public/" class="button medium black">Descubir</a> 
        </div>
      </div>
    </div><!-- End description -->
